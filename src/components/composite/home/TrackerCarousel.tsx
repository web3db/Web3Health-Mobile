...
export default function TrackerCarousel({
      ...
      >
        ...
        >
          {onGrantAll ? (
            ...
            >
              <Text style={{ color: c.text.inverse, fontWeight: "800" }}>
                Grant all
              </Text>
            </Pressable>
          ) : null}
  ...
  const windowLabel =
    windowKey === "24h" ? "today" : windowKey ? `last ${windowKey}` : undefined;
          ...
          >
            <Card style={{ minWidth: baseMinWidth }}>
                ...
                >
                  {!!a.source && (
                    <Text style={{ color: c.text.muted, fontSize: 10 }}>
                      {a.source === "healthconnect"
                        ? "HC"
                        : a.source === "healthkit"
                          ? "HK"
                          : a.source.toUpperCase().slice(0, 2)}
                    </Text>
                  )}
                  {!!windowKey && (
                    <Text
              ...
              <View style={{ marginTop: 4 }}>
                ...
                {!!windowLabel && (
                  <Text
                    style={{ color: c.text.muted, fontSize: 12, marginTop: 2 }}
                  >
                    {windowLabel}
                  </Text>
                )}
